...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Chat bubble */}
      {open && (
        <div className="bg-sand-50 rounded-lg p-4 w-72 border border-sand-200 animate-slide-in-right">
          <div className="flex items-start justify-between gap-3 mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-bold text-lead-900 text-sm">Hype Academia</div>
            ...
            <button
              ...
              className="text-lead-400 hover:text-lead-600 transition-colors p-1"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="bg-sand-50 rounded-xl p-3 mb-3">
            <p className="text-lead-700 text-sm leading-relaxed">
